...
public class WSAbstractService{
	...
	private double[] getInternalObjectiveValues(int i) {
		...
		} else if ("Availability".equals(WSConcreteService.objectives[i])) {
			v = v == 0? getOwnObjectiveValues(i) : v * getOwnObjectiveValues(i);
		...
		} else if ("Compliance".equals(WSConcreteService.objectives[i])) {
			v += getOwnObjectiveValues(i);
		...
		} else if ("Practices".equals(WSConcreteService.objectives[i])) {
			v += getOwnObjectiveValues(i);
